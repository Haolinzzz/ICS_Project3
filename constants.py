...
gravconst_e = G*Me*Ms            # gracitational constant of Earth
gravconst_m = G*Mm*Ms            # gracitational constant of Mars 
gravconst_c = G*Mc*Ms            # gracitational constant of comet 
